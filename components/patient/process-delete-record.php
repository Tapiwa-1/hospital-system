...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($sure == 'Yes') { // Delete the record.
            ...
            mysqli_stmt_prepare($q, 'DELETE FROM patientillness WHERE id=? LIMIT 1');
        ...
        $q = mysqli_stmt_init($dbcon);
        $query = "SELECT illness FROM patientillness WHERE id=?";
        ...
        if (mysqli_num_rows($result) == 1) { // Valid user ID, display the form.
            ...
            $illness = htmlspecialchars($row[0], ENT_QUOTES);
?>
            <div class="row">
                <div class="col-md-4 m-auto">
                    <h5>Are you sure you want to permanently delete <?php echo $illness; ?></h5>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis veniam aperiam voluptatem cupiditate minus quo praesentium facilis ullam quisquam labore ducimus repellat deserunt, autem reprehenderit asperiores architecto dolores excepturi! Ab.</p>

    ...
    <div class="table-responsive">
        ...
        try {
            ...
            $query = "SELECT id, practitioner,illness, prescription,results, moreinfo,
                    ...
                    FROM patientillness
                    WHERE patient =" . $_SESSION['id'] . " AND responded IS NOT NULL 
                    ORDER BY adate DESC";
            ...
            if ($result) { // If it ran OK, display the records.
                ...
                while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                    ...
                    echo
                    '<tr>
                        <td scope="col">' . $ro['name'] . '</td>
                        <td scope="col">' . $row['illness'] . '</td>
                        <td scope="col">' . $row['prescription'] . '</td>
                        <td scope="col">' . $row['sdate'] . '</td>
                        <td scope="col">' . $row['adate'] . '</td>
                        <td scope="col">' . $row['rdate'] . '</td>
                        <td scope="col">' . $row['results'] . '</td>
                        <td scope="col">' . $row['moreinfo'] . '</td>

    ...
    <main>
        <div class="container-fluid">
            <nav class="nav flex-column flex-md-row justify-content-sm-between">
                <a class="nav-link" href="administrator-addfinance.php ">Add finance</a>
                <a class="nav-link" href="administrator-viewrecordsfinance.php ">Finance Records</a>
                <a class="nav-link active" href="administrator-adddepartmentfinance.php ">add departments</a>
                <a class="nav-link" href="administrator-departmentfinance.php ">finance departments</a>
                <a class="nav-link" href="administrator-Searchfinance.php ">search finance</a></li>
            </nav>
    ...
    <main>
        <div class="container-fluid">
            <nav class="nav flex-column flex-md-row justify-content-sm-between">
                <a class="nav-link" href="administrator-viewrecordspatient.php">Patient Records</a>
                <a class="nav-link" <a href="administrator-patientillness.php">illness Records</a>
                <a class="nav-link active" href="administrator-Searchpatient.php">search Patient</a>
            </nav>
    ...
    <main>
        <div class="container-fluid">
            <nav class="nav flex-column flex-md-row justify-content-sm-between">
                <a class="nav-link" href="administrator-addpractitioner.php">Add Practitioner</a>
                <a class="nav-link" href="administrator-viewrecordspractioner.php">Practitioner Records</a>
                <a class="nav-link active" href="administrator-adddepartmentpractitioner.php">Add Departments</a>
                <a class="nav-link" href="administrator-departmentpractitioner.php">Practitioner Departments</a>
                <a class="nav-link" href="administrator-Searchpractitioner.php">Search</a>
            </nav>
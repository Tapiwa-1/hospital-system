...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (empty($errors)) { // If everything's OK.   
            ...
            $query = 'SELECT id FROM practitionerdetails WHERE email=? AND id !=?';
            ...
            if (mysqli_num_rows($result) == 0) { // e-mail does not exist in another record
                ...
                $query = 'UPDATE practitionerdetails 
    ...
    $q = mysqli_stmt_init($dbcon);
    $query = "SELECT id, firstname, lastname, gender, email, address1, address2, phone, experience, payment, department
